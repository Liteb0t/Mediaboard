...
void addURLsToController<State>(FuzeHttp::Controller<State*>* controller) {
	...
	controller->addPattern(verb::delete_, deleteThreadGroupPermission,	"api", "board", std::string{}, "thread", int(), "permissions", "group", int());
	controller->addPattern(verb::post, addThreadUserPermission,			"api", "board", std::string{}, "thread", int(), "permissions", "user", int());
	controller->addPattern(verb::put, updateThreadUserPermissions,		"api", "board", std::string{}, "thread", int(), "permissions", "user", int());
	controller->addPattern(verb::delete_, deleteThreadUserPermission,	"api", "board", std::string{}, "thread", int(), "permissions", "user", int());
