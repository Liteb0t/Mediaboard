...
void addURLsToController(FuzeHttp::Controller<State*>* controller) {
	...
	(verb::delete_, deleteBoard, Client{},			"api", "board", std::string{})
	(verb::get, getBoardPermissions,				"api", "board", std::string{}, "permissions")
	(verb::post, addBoardGroupPermission,			"api", "board", std::string{}, "permissions", "group", int())
	(verb::put, updateBoardGroupPermissions,		"api", "board", std::string{}, "permissions", "group", int())
	(verb::delete_, deleteBoardGroupPermission,		"api", "board", std::string{}, "permissions", "group", int())
	(verb::post, addBoardUserPermission,			"api", "board", std::string{}, "permissions", "user", int())
	(verb::put, updateBoardUserPermissions,			"api", "board", std::string{}, "permissions", "user", int())
	(verb::delete_, deleteBoardUserPermission,		"api", "board", std::string{}, "permissions", "user", int())
#ifdef WITH_WEBRTC
	// (verb::post, createRoom, Client{},			"api", "board", std::string{}, "room")
	(verb::get, getRoom,							"api", "board", std::string{}, "room", int())
	(verb::get, getRooms,							"api", "board", std::string{}, "rooms")
#endif
	(verb::post, createMessage, Client{},			"api", "board", std::string{}, "message")
	(verb::delete_, deleteMessage, Client{},		"api", "board", std::string{}, "thread", int(), "message", int())
	(verb::post, createThread, Client{},			"api", "board", std::string{}, "thread")
